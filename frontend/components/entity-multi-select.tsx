    ...
    return (
        <div className="relative grid gap-3">
            ...
            {open && query.trim().length >= 2 ? (
                <div
                    className="surface-dropdown absolute left-0 right-0 top-full z-20 mt-2 overflow-hidden rounded-[22px]">
                    {loading ? (
                  ...
                  <span className="block text-sm font-semibold text-[var(--color-ink)]">
                    ...
                    {option.sublabel ? (
                      ...
                      {option.sublabel}
                                ...
                                <span
                                    className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--color-deep-teal)]">
                  Add
                </span>
                            </button>
                        ))
