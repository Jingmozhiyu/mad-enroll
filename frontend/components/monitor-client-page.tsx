...
import {getMeetingLocationSummary, getMeetingSummary, sortTasks} from '@/lib/course/format'
import {
                  ...
                  <span className="flex min-w-0 items-center gap-3">
                    ...
                    <span className="truncate text-[var(--search-trigger-text-muted)]">
                      Search courses...
                                    ...
                                    <span
                                        className="rounded-full border border-[var(--search-trigger-hint-border)] bg-[var(--search-trigger-hint-background)] px-2.5 py-1 text-[0.72rem] font-semibold uppercase tracking-[0.14em] text-[var(--search-trigger-hint-text)]">
                    Enter
                  </span>
                                </button>
                            ) : null}
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <dl className="mt-5 mb-4 grid gap-3 border-t border-[var(--surface-divider)] pt-4 text-md leading-6 text-[var(--color-ink-soft)]">
                                            ...
                                            {meetingSummary ? (
                                                <div
                                                    className="grid grid-cols-[8.5rem_minmax(0,1fr)] items-start gap-3">
                                        ...
                                        <div
                                            className="mt-auto flex flex-wrap justify-end gap-3 border-t border-[var(--surface-divider)] pt-4">
                                            <button
