...
import {fetchCourseSuggestions} from '@/lib/api/client/madgrades'
    ...
    return (
        <div className="relative" ref={containerRef}>
            ...
            {open && value.trim().length >= 2 ? (
                <div
                    className="surface-dropdown absolute left-0 right-0 top-full z-20 mt-2 overflow-hidden rounded-[18px]">
                    {loading ? (
