        ...
        <div className="grid gap-4 px-1">
            ...
            <section className="grid gap-6 xl:grid-cols-[minmax(260px,0.33fr)_minmax(0,0.67fr)] xl:items-start">
                ...
                <div className="grid gap-0">
                    ...
                    <div
                        className="flex flex-wrap items-center justify-center gap-4 pt-1 text-sm text-[var(--color-ink-soft)]">
            ...
            <section className="pt-1">
                ...
                <div
                    className="mt-0 flex flex-wrap items-center justify-center gap-5 text-sm text-[var(--color-ink-soft)]">
                    <div className="inline-flex items-center gap-3">
